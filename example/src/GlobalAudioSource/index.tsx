...
const ExampleSelect = () => {
  return (
    <>
      ...
      <p>
        The following examples leverage useGlobalAudioPlayer to control a
        single, global audio source. At any time, this audio can be managed by
        the playbar at the bottom of the page.
      </p>
      <h4>Examples</h4>
