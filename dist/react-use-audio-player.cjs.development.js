...
var playerContext = /*#__PURE__*/React__default.createContext(null);
var positionContext = /*#__PURE__*/React__default.createContext({
  position: 0,
...
var useAudioPlayer = function useAudioPlayer(options) {
  ...
  var boundHowlerMethods = React.useMemo(function () {
    return {
...
var useAudioPosition = function useAudioPosition(config) {
  ...
  var speed = React.useCallback( // This should update the playback speed if the rate is provided
  ...
  var percentComplete = React.useMemo(function () {
